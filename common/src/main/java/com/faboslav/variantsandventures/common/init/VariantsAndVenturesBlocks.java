...
public final class VariantsAndVenturesBlocks
{
	...
	public static Supplier<Block> GELID_WALL_HEAD = BLOCKS.register("gelid_wall_head", () -> WallSkullBlockAccessor.variantsandventures$createWallSkullBlock(SkullBlockType.GELID.get(), AbstractBlock.Settings.create().instrument(Instrument.ZOMBIE).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).dropsLike(GELID_HEAD.get())));
	public static Supplier<Block> THICKET_HEAD = BLOCKS.register("thicket_head", () -> SkullBlockAccessor.variantsandventures$createSkullBlock(SkullBlockType.THICKET.get(), AbstractBlock.Settings.create().instrument(Instrument.ZOMBIE).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY)));
	public static Supplier<Block> THICKET_WALL_HEAD = BLOCKS.register("thicket_wall_head", () -> WallSkullBlockAccessor.variantsandventures$createWallSkullBlock(SkullBlockType.THICKET.get(), AbstractBlock.Settings.create().instrument(Instrument.ZOMBIE).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).dropsLike(THICKET_HEAD.get())));
	public static Supplier<Block> VERDANT_SKULL = BLOCKS.register("verdant_skull", () -> SkullBlockAccessor.variantsandventures$createSkullBlock(SkullBlockType.VERDANT.get(), AbstractBlock.Settings.create().instrument(Instrument.SKELETON).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY)));
	public static Supplier<Block> VERDANT_WALL_SKULL = BLOCKS.register("verdant_wall_skull", () -> WallSkullBlockAccessor.variantsandventures$createWallSkullBlock(SkullBlockType.VERDANT.get(), AbstractBlock.Settings.create().instrument(Instrument.SKELETON).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).dropsLike(VERDANT_SKULL.get())));
