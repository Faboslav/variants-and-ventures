...
public class VariantsAndVenturesItemGroups
{
	...
	public static void registerItemGroups(RegisterItemGroupsEvent event) {
		event.register(
			...
			builder -> builder.icon(() -> VariantsAndVenturesItems.GELID_SPAWN_EGG.get().getDefaultStack()).displayName(Text.translatable("item_group." + VariantsAndVentures.MOD_ID + ".main_tab")),
