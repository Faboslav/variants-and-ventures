...
public final class VariantsAndVenturesItems
{
	...
	public final static RegistryEntry<Item> MURK_SPAWN_EGG = ITEMS.register("murk_spawn_egg", () -> new DispenserAddedSpawnEgg(VariantsAndVenturesEntityTypes.MURK, 12698049, 0xA276A9, new Item.Settings().maxCount(64)));
	...
	public final static RegistryEntry<Item> MURK_SKULL = ITEMS.register("murk_skull", () -> new VerticallyAttachableBlockItem(VariantsAndVenturesBlocks.MURK_SKULL.get(), VariantsAndVenturesBlocks.MURK_WALL_SKULL.get(), (new Item.Settings()).rarity(Rarity.UNCOMMON), Direction.DOWN));
