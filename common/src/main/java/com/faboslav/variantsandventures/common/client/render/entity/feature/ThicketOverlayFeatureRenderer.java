...
public class ThicketOverlayFeatureRenderer extends FeatureRenderer<ZombieEntityRenderState, DrownedEntityModel> {
	private static final Identifier SKIN = VariantsAndVentures.makeID("textures/entity/thicket/thicket_overlay.png");
	private final DrownedEntityModel model;
	private final DrownedEntityModel babyModel;

	public ThicketOverlayFeatureRenderer(FeatureRendererContext<ZombieEntityRenderState, DrownedEntityModel> context, EntityModelLoader loader) {
		super(context);
