...
public class EndGrassBlock extends SpreadableBlock implements Fertilizable
{
	...
	public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
		...
		BlockState blockState = VariantsAndVenturesBlocks.END_GRASS.get().getDefaultState();
