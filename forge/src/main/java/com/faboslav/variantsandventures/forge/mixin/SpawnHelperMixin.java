package com.faboslav.variantsandventures.forge.mixin;
...
public final class SpawnHelperMixin
{
	...
	@WrapOperation(
		...
		at = @At(
			value = "INVOKE",
			target = "Lnet/minecraftforge/event/ForgeEventFactory;checkSpawnPosition(Lnet/minecraft/entity/mob/MobEntity;Lnet/minecraft/world/ServerWorldAccess;Lnet/minecraft/entity/SpawnReason;)Z"
		)
	)
